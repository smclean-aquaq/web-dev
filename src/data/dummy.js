...
import { AiOutlineDashboard, AiOutlineBarChart, AiOutlineAreaChart, AiOutlineStock, AiOutlineLineChart, AiOutlineFund } from 'react-icons/ai';
...
export const chatData = [
  ...
  },
  {
    ...
    desc: 'Sarah sent you new message',
    time: '11:56 AM',
  },
  {
    image:
...
export const customersData = [
  {
    CustomerID: 1001,
    CustomerName: 'James Massey',
    CustomerEmail: 'jm@gmail.com',
    CustomerImage:
      avatar2,
    ProjectName: 'React Interface',
    Status: 'Active',
    StatusBg: '#8BE78B',
    Weeks: '40',
    Budget: '$2.4k',
  ...
  },
  {
    ...
    CustomerName: 'Sarah McLean',
    CustomerEmail: 'sm@gmail.com',
    ProjectName: 'Github Admin',
    Status: 'Active',
    CustomerImage:
      avatar3,
  ...
  },
  {
    ...
    CustomerName: 'Crimhthann Murtagh',
    CustomerEmail: 'cm@gmail.com',
    ProjectName: 'Breaking Github',
    Status: 'Pending',
    CustomerImage:
      avatar4,
    StatusBg: '#FEC90F',
  ...
  },
  {
    ...
    CustomerName: 'Hannah Storeng',
    CustomerEmail: 'hs@gmail.com',
    ProjectName: 'Fix React',
    Status: 'Completed',
    CustomerImage:
      avatar,
    StatusBg: '#8BE78B',
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'WebDev Catch Up 1',
    Location: 'Belfast HQ',
    StartTime: '2022-11-04T14:30:00.000Z',
    EndTime: '2022-11-04T15:00:00.000Z',
    CategoryColor: '#1aaa55',
  },
  {
    Id: 2,
    Subject: 'WebDev Catch Up 2',
    Location: 'Belfast HQ',
    StartTime: '2022-11-11T14:30:00.000Z',
    EndTime: '2022-11-11T15:00:00.000Z',
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Current price for each instrument, with the ability to display up to 3 days history (filter option for 1/2/3 days, etc).',
    Type: 'Story',
    Priority: 'Low',
  ...
  },
  {
    ...
    Title: 'Task - 29002',
    Status: 'Open',
    Summary: 'Max & min prices from (1) in summary boxes',
    Type: 'Improvement',
    Priority: 'Normal',
    Tags: 'Improvement',
    Estimate: 6,
  ...
  },
  {
    ...
    Title: 'Task - 29003',
    Status: 'Open',
    Summary: 'A time series graph showing the running average price for each instrument for the day as a line graph, with a sliding time filter.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29004',
    Status: 'Open',
    Summary: 'Last value cache for each instrument as a dynamic table, with colour and symbolic change on table cell for price change (e.g. price goes down –> red down arrow, up –> green up arrow).',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'IE',
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: 'Task - 29005',
    Status: 'Open',
    Summary: 'Summary box detailing the highest traded instrument over a date/time range.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Customer',
    Estimate: '3.5',
  ...
  },
  {
    ...
    Title: 'Task - 29007',
    Status: 'Open',
    Summary: 'Volatility graph for each instrument (with options for date range history and filters on instrument)',
    Type: 'Improvement',
    Priority: 'Low',
    Tags: 'Validation',
    Estimate: 1.5,
